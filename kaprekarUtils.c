...
int isKaprekar(int n) {
  ...
  //Changed "n * (long) n" to "(long) n * n"
  //long modulus was changed from 0 to 1
  int i;
  ...
  //Spelling of "modulous" changed to "modulus"
  //Spelling of "numberofDigits" changed to "numDigits"
